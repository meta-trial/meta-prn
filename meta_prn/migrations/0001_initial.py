    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewer', models.ForeignKey(help_text='Select a name from the list', on_delete=django.db.models.deletion.PROTECT, related_name='+', to='meta_prn.UnblindingReviewerUser', verbose_name='Unblinding request reviewed by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('requestor', models.ForeignKey(help_text='Select a name from the list', on_delete=django.db.models.deletion.PROTECT, related_name='+', to='meta_prn.UnblindingRequestorUser', verbose_name='Unblinding requested by')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_attempts', models.IntegerField(verbose_name='How many attempts have been made to contact the participant by phone')),
                ...
                ('loss_category', models.CharField(max_length=25, verbose_name='Category of loss to follow up')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewer', models.ForeignKey(blank=True, db_constraint=False, help_text='Select a name from the list', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='meta_prn.UnblindingReviewerUser', verbose_name='Unblinding request reviewed by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('requestor', models.ForeignKey(blank=True, db_constraint=False, help_text='Select a name from the list', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='meta_prn.UnblindingRequestorUser', verbose_name='Unblinding requested by')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_offschedule_reason', models.CharField(blank=True, max_length=150, null=True, verbose_name='If OTHER, please specify')),
                ...
                ('action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('offschedule_reason', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='meta_lists.OffstudyReasons', verbose_name='Reason patient was terminated from the study')),
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.Site')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transferred_consent', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='If transferred, has the patient provided consent to be followed-up?')),
                ('action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.ActionItem')),
                ('offschedule_reason', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='meta_lists.OffstudyReasons', verbose_name='Reason patient was terminated from the study')),
                ('parent_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_prn_un_subject_b4c71f_idx'),
        ),
        migrations.AddIndex(
            model_name='unblindingrequest',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_prn_un_subject_add655_idx'),
        ),
        migrations.AddIndex(
            model_name='protocoldeviationviolation',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_prn_pr_subject_6d4791_idx'),
        ),
        migrations.AddIndex(
            model_name='onschedule',
            index=models.Index(fields=['id', 'subject_identifier', 'onschedule_datetime', 'site'], name='meta_prn_on_id_6e5134_idx'),
        ),
        migrations.AddIndex(
            model_name='losstofollowup',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_prn_lo_subject_260e98_idx'),
        ),
        migrations.AddIndex(
            model_name='endofstudy',
            index=models.Index(fields=['id', 'subject_identifier', 'offschedule_datetime', 'site'], name='meta_prn_en_id_a50384_idx'),
        ),
    ]
